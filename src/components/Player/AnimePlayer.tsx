        ...
        <div className="flex items-center justify-between pointer-events-auto">
           ...
           <div className="flex items-center gap-2 md:gap-5 relative">
              <div className="relative">
                  ...
                  {activeMenu === 'main' && (
                       <div className="absolute bottom-12 right-0 bg-zinc-950/80 backdrop-blur-3xl border border-white/5 ring-1 ring-white/10 rounded-2xl shadow-[0_8px_40px_rgba(0,0,0,0.8)] p-1.5 w-44 md:w-52 max-h-[140px] sm:max-h-[160px] md:max-h-[180px] overflow-y-auto scrollbar-hide z-[70] flex flex-col gap-0.5 animate-in slide-in-from-bottom-2">
                   ...
                   {activeMenu === 'vGesture' && (
                       <div className="absolute bottom-12 right-0 bg-zinc-950/80 backdrop-blur-3xl border border-white/5 ring-1 ring-white/10 rounded-2xl shadow-[0_8px_40px_rgba(0,0,0,0.8)] p-1.5 w-40 md:w-48 max-h-[120px] sm:max-h-[140px] md:max-h-[160px] overflow-y-auto scrollbar-hide z-[70] flex flex-col gap-0.5 animate-in slide-in-from-bottom-2">
                   ...
                   {activeMenu === 'quality' && (
                       <div className="absolute bottom-12 right-0 bg-zinc-950/80 backdrop-blur-3xl border border-white/5 ring-1 ring-white/10 rounded-2xl shadow-[0_8px_40px_rgba(0,0,0,0.8)] p-1.5 w-28 md:w-36 max-h-[120px] sm:max-h-[140px] md:max-h-[160px] overflow-y-auto scrollbar-hide z-[70] flex flex-col gap-0.5 animate-in slide-in-from-bottom-2">
                           <button onClick={(e)=>{e.stopPropagation(); setActiveMenu('main')}} className="flex items-center gap-1.5 text-[9px] md:text-[10px] px-2 py-1 font-black text-zinc-400 border-b border-white/10 mb-0.5"><ChevronLeft size={12}/> BACK</button>
                   ...
                   {activeMenu === 'speed' && (
                       <div className="absolute bottom-12 right-0 bg-zinc-950/80 backdrop-blur-3xl border border-white/5 ring-1 ring-white/10 rounded-2xl shadow-[0_8px_40px_rgba(0,0,0,0.8)] p-1.5 w-24 md:w-32 max-h-[120px] sm:max-h-[140px] md:max-h-[160px] overflow-y-auto scrollbar-hide z-[70] flex flex-col gap-0.5 animate-in slide-in-from-bottom-2">
                           <button onClick={(e)=>{e.stopPropagation(); setActiveMenu('main')}} className="flex items-center gap-1.5 text-[9px] md:text-[10px] px-2 py-1 font-black text-zinc-400 border-b border-white/10 mb-0.5"><ChevronLeft size={12}/> BACK</button>
              ...
              {trackSubtitles.length > 0 && (
                <div className="relative">
                    ...
                    {activeMenu === 'subs' && (
                        <div className="absolute bottom-12 right-0 bg-zinc-950/80 backdrop-blur-3xl border border-white/5 ring-1 ring-white/10 rounded-2xl shadow-[0_8px_40px_rgba(0,0,0,0.8)] p-1.5 w-40 md:w-48 max-h-[120px] sm:max-h-[140px] md:max-h-[160px] overflow-hidden z-[70] flex flex-col animate-in slide-in-from-bottom-2">
