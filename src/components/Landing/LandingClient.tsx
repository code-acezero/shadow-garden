          ...
          >
            ...
            <div className="relative bg-gradient-to-b from-transparent via-[#050505] to-[#050505] pt-4 space-y-12 z-10">
               ...
               <section className="w-full max-w-5xl mx-auto px-4 my-8">
                 <div className="relative rounded-3xl border border-primary-500/30 bg-gradient-to-r from-[#120816] via-[#0d0714] to-[#120816] p-6 shadow-[0_0_40px_rgba(220,38,38,0.15)] flex flex-col sm:flex-row items-center justify-between gap-6 overflow-hidden">
                   <div className="flex items-center gap-4 text-left">
                     <div className="relative w-16 h-16 sm:w-20 sm:h-20 shrink-0 bg-primary-950/40 rounded-2xl border border-primary-500/30 overflow-hidden flex items-center justify-center p-1 shadow-inner">
                       <img 
                         src={FOOTER_GIF || '/images/index/sticker-1.gif'} 
                     ...
                     <div>
                       <div className="flex items-center gap-2">
                         <span className="px-2 py-0.5 rounded-full bg-primary-600/30 border border-primary-500/40 text-primary-400 text-[10px] font-bold tracking-widest uppercase">
                           Spread The Word
                         </span>
                         <span className="text-xs text-zinc-400">✨ Join the Guild</span>
                       </div>
                       <h4 className="text-lg font-bold text-white mt-1">Invite your friends to Shadow Garden!</h4>
                       <p className="text-xs text-zinc-400">Share the sanctuary to unlock watch parties, live streams, and 15,000+ anime & donghua.</p>
                     </div>
                   </div>
                   <Button
                     onClick={() => setShowHomeShareModal(true)}
                     className="bg-primary-600 hover:bg-primary-500 text-white border-0 h-11 px-6 rounded-2xl font-bold uppercase tracking-wider text-xs shadow-lg shadow-primary-900/30 flex items-center gap-2 shrink-0 group hover:scale-105 transition-all"
                   >
