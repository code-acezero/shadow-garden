...
import { Home, Flame, MessageCircle, Heart, User } from 'lucide-react';
      ...
      <div className="flex justify-between items-center px-6 py-2">
        {tabs.map((tab) => {
          ...
          return (
            ...
            >
              <Icon size={24} strokeWidth={isActive ? 2.5 : 2} className={cn(isActive && "drop-shadow-[0_0_8px_rgba(220,38,38,0.5)]")} />
              <span className={cn(
