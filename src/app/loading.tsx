...
const BreathingLoader = () => (
  ...
  <svg viewBox="0 0 24 24" className="w-16 h-16 opacity-70 drop-shadow-[0_0_10px_rgba(220,38,38,0.3)]">
    ...
    {/* Slow Rotation to keep it alive */}
    <motion.g
        animate={{ rotate: 360 }}
    ...
    >
        ...
        <motion.path
            ...
            animate={{
                ...
                // Stroke visible during the whole active phase
                strokeOpacity: [1, 1, 1, 1, 1, 0]
            }}
            transition={{
                duration: 3, // 3 Seconds per full loop
                repeat: Infinity,
                ease: "easeInOut",
                times: [0, 0.2, 0.45, 0.7, 0.9, 1] // Timing of the stages
            }}
        />
...
export default function Loading() {
  return (
    <div className="w-full h-screen flex flex-col items-center justify-center bg-transparent pointer-events-none">
        <BreathingLoader />
    </div>
  );
}