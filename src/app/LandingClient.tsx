               ...
               <div className="relative z-20 text-center px-4 max-w-6xl w-full">
                 <motion.div initial={{ y: 30, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 1, delay: 0.5 }}>
                   ...
                   <div className="relative inline-block mb-6">
                     ...
                     <h1 className="text-5xl md:text-8xl font-normal tracking-wide font-demoness text-red-600 drop-shadow-[0_0_30px_rgba(220,38,38,0.6)] relative z-10" style={{ fontFamily: 'var(--font-demoness), serif' }}>SHADOW GARDEN</h1>
                     ...
                     <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-3">
                        {isLoadingTrending ? (
                           ...
                           trending.map((anime, i) => (
                              <Link key={anime.id} href={`/watch/${anime.id}`} className="relative w-full aspect-[2/3] rounded-3xl overflow-hidden cursor-pointer group border border-white/10 hover:border-red-500/50 transition-all hover:scale-105 hover:shadow-[0_0_20px_rgba(220,38,38,0.3)]">
                                 ...
                                 <div className="absolute top-2 right-2 w-7 h-7 rounded-full bg-red-600/90 backdrop-blur-md flex items-center justify-center font-black text-xs border border-red-400 shadow-[0_0_10px_red] z-10">{i + 1}</div>
                                 <div className="absolute bottom-0 w-full p-3 text-center">
                                    <h4 className="text-xs font-bold text-white mb-1 leading-tight drop-shadow-md line-clamp-2 group-hover:text-red-400 transition-colors">{anime.title}</h4>
                                 </div>
                              </Link>
                           ))
                        )}
